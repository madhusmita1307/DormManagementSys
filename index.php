...
<body>
    <div class="main-wrapper">
        ...
        <!-- top-container style="position: relative; padding-top: 100px;"-->
        <div class=" auth-wrapper no-block justify-content-center align-items-center position-relative" >
            <div style="display: block; margin:0 auto; width:50%; padding: 100px 0;"> 
                        ...
                        <form class="mt-4" method="POST">
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center mt-5">
                                   <a href="admin/index.php" class="text-danger">Go to Director's Panel</a>
                                </div>
                            </div>
                        </form>
                    </div>
